...
public class StringJoin {
	 ...
	 * @see StringJoiner
	 */
	public static final <T extends Object> String join(T[] objs, String delimiter) {
	 ...
	 * @see StringJoiner
	 */
	public static final <T extends Object> String join(T[] objs, int off, int len, String delimiter) {
		StringBuilder sb = new StringBuilder();
	...
	public static final <T extends Object> void join(T[] objs, int off, int len, String delimiter, StringBuilder dst) {
		try {
	...
	public static final <T extends Object> void join(T[] objs, int off, int len, String delimiter, Appendable dst) throws IOException {
	...
	public static final String repeatJoin(String str, String separator, int repeats) {
		int strLen = str.length();
	...
	public static final String repeatJoin(String str, char separator, int repeats) {
		int strLen = str.length();
		int off = 0;
		if(repeats > 0) {
	...
	public static final void repeatJoin(String str, String separator, int repeats, Appendable dst) throws IOException {
		if(repeats > 0) {
			for(int i = 0, size = repeats - 1; i < size; i++) {
				dst.append(str);
	...
	public static final void repeatJoin(String str, char separator, int repeats, Appendable dst) throws IOException {
		if(repeats > 0) {
			for(int i = 0, size = repeats - 1; i < size; i++) {
				dst.append(str);
				dst.append(separator);
